    ...
    >
      <div className="row mt-5">
        <div className="col">
          ...
          <p>
            &copy;2010 - 2024, Not Zerodha Broking Ltd. All rights reserved. All
            rights reserved.
          </p>
        </div>
        <div className="col">
        ...
        <div className="mt-5 fs-16px text-small text-muted">
          <p>
            Zerodha Broking Ltd: Member of NSE & BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through Zerodha Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Zerodha Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Zerodha, #153/154, 4th Cross,
            Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase,
            Bangalore - 560078, Karnataka, India. For any complaints pertaining
